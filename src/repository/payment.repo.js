...
export async function addPayment(data) {
    const res = await pool.query(`INSERT INTO "payment_method" ("name", "desc") VALUES ($1, $2)
...
export async function findAllPayment(params) {
    ...
    const res = await pool.query(`SELECT "id", "name", "desc", "created_at", "updated_at" FROM "payment_method"
